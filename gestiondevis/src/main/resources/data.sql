...
--INIT DEVIS (17 devis)
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (1, 1200, 5.5, 586, true, 20, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (2, 510.25, 20, 152, false, 10, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (3, 1754.50, 20, 500, true, 150, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (4, 45.50, 20, 10, true, 8, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (5, 1452.50, 20, 155, true, 140, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (6, 25.50, 20, 10, false, 5, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (7, 114.50, 20, 41, true, 12, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (8, 981.50, 5.5, 221, false, 56, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (9, 910.50, 20, 115, false, 55, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (10, 123.50, 5.5, 10, true, 11, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (11, 456.50, 5.5, 55, true, 44, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (12, 789.50, 20, 77, false, 78, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (13, 8522.50, 20, 810, false, 554, false, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (14, 354.50, 20, 33, true, 33, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (15, 221.50, 5.5, 22, false, 21, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (16, 457.50, 20, 40, true, 48, true, '2019-01-01');
insert into DEVIS(REF, MONTANT_HC, TAXE, MONTANT_APPORT, APPORT_RECU, DUREE_ESTIMEE, DEVIS_ACCEPTE, DATE_DEVIS) values (17, 666.50, 5.5, 15, true, 74, true, '2019-01-01');
